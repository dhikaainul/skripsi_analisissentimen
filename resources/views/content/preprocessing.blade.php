      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header">
            <a class="btn btn-outline-primary" href="/proses-preprocessing" role="button">Preprocessing Data</a>
          </div>
          <div class="card-body">
            ...
            <table class="table datatable">
              <thead>
                <tr>
                  ...
                  <th class="text-center" width="500px" scope="col">Hasil Preprocessing</th>
                  <!-- <th scope="col">Platform</th> -->
                  <th class="text-center" width="1px" scope="col">Sentimen</th>
                </tr>
              </thead>
              <tbody>
                <!-- {{ $preprocessing }} -->
